    ...
    def generateOneStepNeiborsWithConnections(self, prog):
        ...
        for i in range(prog.get_length()):
            ...
            for m in range(GeneticOperations.N_INSTRUCTION_ONESTEPMUT):
                ...
                self.pheno_connects[TwoInputBooleanFuncsMulti.phenotype(prog)][TwoInputBooleanFuncsMulti.phenotype(mutProg)] += 1
                self.pheno_connects[TwoInputBooleanFuncsMulti.phenotype(mutProg)][TwoInputBooleanFuncsMulti.phenotype(prog)] += 1
        reg_prog = copy.deepcopy(prog)
        reg_prog.regulator = 1 - prog.regulator
        self.pheno_connects[TwoInputBooleanFuncsMulti.phenotype(prog)][TwoInputBooleanFuncsMulti.phenotype(reg_prog)] += 1
        self.pheno_connects[TwoInputBooleanFuncsMulti.phenotype(reg_prog)][TwoInputBooleanFuncsMulti.phenotype(prog)] += 1
